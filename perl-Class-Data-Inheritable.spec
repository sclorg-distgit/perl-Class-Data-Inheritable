%{?scl:%scl_package perl-Class-Data-Inheritable}
...
Name:           %{?scl_prefix}perl-Class-Data-Inheritable
Version:        0.08
Release:        34%{?dist}
...
%build
%{?scl:scl enable %{scl} '}perl Makefile.PL INSTALLDIRS=vendor && make%{?scl:'}
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.08-34
- SCL
